...
contract RenewableEnergyMining is Context, IBEP20 {
    ...
    uint256 public maxWalletBalance = 20_000_000 * 10 ** decimals(); // 2% of total supply
    uint256 public MaxTradeLimit = 2_500_000 * 10 ** decimals();    // 0.25% of total supply
