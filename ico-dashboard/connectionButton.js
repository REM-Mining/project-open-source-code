var user;
var tokenAddress = "0xdA524d01298dd9605Dd1C66a4b2d8885b05A46C9";
var presaleAddress = "0xbe97be48f435ce4e68c6411d1edf3ae56d9a191c";
var accounts;
...
async function fetchAccountData() {
    ...
    if (accounts.length > 0) {
        ...
        if (chainId != 56) {
            alert(`You're currently connected to the ${chainData.name}. Please connect to the BNB Smart Chain Mainnet to access full functionality of this dApp!`)
            onDisconnect()
        }
